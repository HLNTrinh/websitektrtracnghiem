    ...
    return (
      <div className="result-overview-shell">
        <aside className="result-sidebar">
          <div className="result-sidebar-brand">
            <div className="result-sidebar-logo">🎓</div>
            <div>
              <p className="result-sidebar-brand-name">EduQuiz</p>
              <p className="result-sidebar-brand-sub">GIÁO VIÊN</p>
            </div>
          </div>
